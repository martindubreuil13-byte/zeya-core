...
const semanticSchema = {
  ...
  properties: {
    ...
    businessLearningSignals: { type: "array", maxItems: 12, items: { type: "object", additionalProperties: false, required: ["kind", "summary", "sourceTurns", "confidence", "requiresOwnerReview"], properties: { kind: { enum: learningKinds }, summary: { type: "string", maxLength: 500 }, sourceTurns: { type: "array", minItems: 1, maxItems: 12, items: { type: "integer", minimum: 0 } }, confidence: { type: "number", minimum: 0, maximum: 1 }, requiresOwnerReview: { const: true } } } },
